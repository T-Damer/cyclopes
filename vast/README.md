...
Use one verified H200 with the image `pytorch/pytorch:2.7.1-cuda12.8-cudnn9-runtime`, at least 140 GB disk, 24 CPU cores, and 40 GB free after checkout/data staging.
